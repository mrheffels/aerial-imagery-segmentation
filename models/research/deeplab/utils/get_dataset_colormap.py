...
def create_dronedeploy_label_colormap():
    """Creates a label colormap used in DroneDeploy segmentation benchmark.
...
def create_label_colormap(dataset=_PASCAL):
  ...
  """
    ...
    elif dataset == _DRONEDEPLOY:
        return create_dronedeploy_label_colormap()
    else:
