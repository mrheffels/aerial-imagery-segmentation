from libs import custom_training_keras
...
if __name__ == '__main__':
    ...
    # train the model
    model = models_keras.build_unet(encoder='resnet50')
    with tf.device("gpu"):
        custom_training_keras.train_model(dataset, model)
